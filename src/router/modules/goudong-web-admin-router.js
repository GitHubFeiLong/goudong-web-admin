    ...
    children: [
      {
        ...
        children: [
          ...
          },
          {
            ...
            type: 2,
            openModel: 0,
            path: '/api/file/user-server/export/user',
            method: '["GET"]',
          ...
          },
          {
            ...
            type: 2,
            openModel: 0,
            path: '/api/user/base-user/change-enabled/*',
            method: '["PUT"]',
            permissionId: 'sys:user:enable',
          },
          {
            name: '锁定用户',
            type: 2,
            openModel: 0,
            path: '/api/user/base-user/change-locked/*',
            method: '["PUT"]',
            permissionId: 'sys:user:lock',
          },
          {
            name: '重置密码',
            type: 2,
